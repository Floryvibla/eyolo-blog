          ...
          <div className="text-[120px] sm:text-[200px] flex gap-x-7 items-center justify-center scale-75 md:scale-100">
            ...
            <div className="relative w-[120px] sm:w-[188px] -mb-8">
              <Image
                ...
                src="https://eyolo-nextjs.vercel.app/images/404/01.jpg"
                height={128}
                width={162}
                alt="post image"
              />
              <Image
                ...
                src="https://eyolo-nextjs.vercel.app/images/404/02.jpg"
                height={128}
                width={162}
                alt="post image"
              />
              <Image
                ...
                src="https://eyolo-nextjs.vercel.app/images/404/03.jpg"
                height={128}
                width={162}
                alt="post image"
              />
              <Image
                ...
                src="https://eyolo-nextjs.vercel.app/images/404/04.jpg"
                height={128}
                width={162}
                alt="post image"
              />
