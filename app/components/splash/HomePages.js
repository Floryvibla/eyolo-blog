          ...
          >
            ...
            <div className="mt-5 mb-6 relative overflow-hidden rounded-xl">
              <Image
                ...
                height={394}
                width={576}
                src={"https://eyolo-nextjs.vercel.app/images/splash/demos/home-1.jpg"}
          ...
          >
            ...
            <div className="mt-5 mb-6 relative overflow-hidden rounded-xl">
              <Image
                ...
                height={394}
                width={576}
                src={"https://eyolo-nextjs.vercel.app/images/splash/demos/home-2.jpg"}
                alt="Inner page image"
              />
            </div>
            <div className="flex justify-between items-center">
          ...
          >
            ...
            <div className="mt-5 mb-6 relative overflow-hidden rounded-xl">
              <Image
                ...
                height={394}
                width={576}
                src={"https://eyolo-nextjs.vercel.app/images/splash/demos/home-3.jpg"}
                alt="Inner page image"
              />
            </div>
            <div className="flex justify-between items-center">
          ...
          >
            ...
            <div className="mt-5 mb-6 relative overflow-hidden rounded-xl">
              <Image
                ...
                height={394}
                width={576}
                src={"https://eyolo-nextjs.vercel.app/images/splash/demos/home-4.jpg"}
                alt="Inner page image"
              />
          ...
          >
            ...
            <div className="mt-5 mb-6 relative overflow-hidden rounded-xl">
              <Image
                ...
                height={394}
                width={576}
                src={"https://eyolo-nextjs.vercel.app/images/splash/demos/home-5.jpg"}
                alt="Inner page image"
              />
              <span className="py-2 pl-3 pr-4 rounded-full bg-primary text-white uppercase flex gap-1 justify-center items-center w-fit absolute top-6 right-6 text-xs tracking-wide">
                <Image
          ...
          >
            ...
            <div className="mt-5 mb-6 relative overflow-hidden rounded-xl">
              <Image
                ...
                height={394}
                width={576}
                src={"https://eyolo-nextjs.vercel.app/images/splash/demos/home-6.jpg"}
                alt="Inner page image"
              />
              <span className="py-2 pl-3 pr-4 rounded-full bg-primary text-white uppercase flex gap-1 justify-center items-center w-fit absolute top-6 right-6 text-xs tracking-wide">
                <Image
