            ...
            <div className="rounded-xl p-3 border border-[#758A7D] bg-white/10 group">
              ...
              <div className="my-3 relative overflow-hidden rounded-lg">
                <Image
                  ...
                  height={500}
                  width={300}
                  src={"https://eyolo-nextjs.vercel.app/images/splash/demos/about.jpg"}
                ...
                >
                  <span className="w-12 h-12 rounded-full bg-primary text-white flex justify-center items-center">
                    <Image
                      height={14}
                      width={14}
                      src={"https://eyolo-nextjs.vercel.app/images/splash/icons/arrow-top-right.svg"}
                      alt="Icon"
                    />
                  </span>
                </Link>
              ...
              <div className="my-3 relative overflow-hidden rounded-lg">
                ...
                <span className="py-2 pl-4 pr-5 rounded-full bg-primary text-white uppercase flex gap-1 justify-center items-center w-fit absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 whitespace-nowrap text-xs">
                  <Image
                    height={18}
                    width={18}
                    src={"https://eyolo-nextjs.vercel.app/images/splash/icons/hand-emoji.svg"}
                    alt="Icon"
                  />
                  coming soon
                </span>
            ...
            <div className="rounded-xl p-3 border border-[#758A7D] bg-white/10 group">
              ...
              <div className="my-3 relative overflow-hidden rounded-lg">
                <Image
                  ...
                  height={500}
                  width={300}
                  src={"https://eyolo-nextjs.vercel.app/images/splash/demos/blog-list.jpg"}
                  alt="Inner page image"
                />
                <Link
                  href={"/blog"}
            ...
            <div className="rounded-xl p-3 border border-[#758A7D] bg-white/10 group">
              ...
              <div className="my-3 relative overflow-hidden rounded-lg">
                <Image
                  ...
                  height={500}
                  width={300}
                  src={"https://eyolo-nextjs.vercel.app/images/splash/demos/post-single.jpg"}
                  alt="Inner page image"
                />
                <Link
            ...
            <div className="rounded-xl p-3 border border-[#758A7D] bg-white/10 group">
              ...
              <div className="my-3 relative overflow-hidden rounded-lg">
                <Image
                  ...
                  height={500}
                  width={300}
                  src={"https://eyolo-nextjs.vercel.app/images/splash/demos/post-single-2.jpg"}
                  alt="Inner page image"
                />
                <span className="py-2 pl-4 pr-5 rounded-full bg-primary text-white uppercase flex gap-1 justify-center items-center w-fit absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 whitespace-nowrap text-xs">
                  <Image
            ...
            <div className="rounded-xl p-3 border border-[#758A7D] bg-white/10 group">
              ...
              <div className="my-3 relative overflow-hidden rounded-lg">
                <Image
                  ...
                  height={500}
                  width={300}
                  src={"https://eyolo-nextjs.vercel.app/images/splash/demos/elements.jpg"}
                  alt="Inner page image"
                />
                <Link
                  href={"/blog/elements"}
            ...
            <div className="rounded-xl p-3 border border-[#758A7D] bg-white/10 group">
              ...
              <div className="my-3 relative overflow-hidden rounded-lg">
                <Image
                  ...
                  height={500}
                  width={300}
                  src={"https://eyolo-nextjs.vercel.app/images/splash/demos/archive.jpg"}
                  alt="Inner page image"
                />
                <Link
                  href={"/archive"}
            ...
            <div className="rounded-xl p-3 border border-[#758A7D] bg-white/10 group">
              ...
              <div className="my-3 relative overflow-hidden rounded-lg">
                <Image
                  ...
                  height={500}
                  width={300}
                  src={"https://eyolo-nextjs.vercel.app/images/splash/demos/video-posts.jpg"}
                  alt="Inner page image"
                />
                <Link
                  href={"/videos"}
            ...
            <div className="rounded-xl p-3 border border-[#758A7D] bg-white/10 group">
              ...
              <div className="my-3 relative overflow-hidden rounded-lg">
                <Image
                  ...
                  height={500}
                  width={300}
                  src={"https://eyolo-nextjs.vercel.app/images/splash/demos/category.jpg"}
                  alt="Inner page image"
                />
                <Link
                  href={"/category"}
            ...
            <div className="rounded-xl p-3 border border-[#758A7D] bg-white/10 group">
              ...
              <div className="my-3 relative overflow-hidden rounded-lg">
                <Image
                  ...
                  height={500}
                  width={300}
                  src={"https://eyolo-nextjs.vercel.app/images/splash/demos/author.jpg"}
                  alt="Inner page image"
                />
                <Link
                  href={"/author"}
            ...
            <div className="rounded-xl p-3 border border-[#758A7D] bg-white/10 group">
              ...
              <div className="my-3 relative overflow-hidden rounded-lg">
                <Image
                  ...
                  height={500}
                  width={300}
                  src={"https://eyolo-nextjs.vercel.app/images/splash/demos/contact.jpg"}
                  alt="Inner page image"
                />
                <Link
                  href={"/contact"}
            ...
            <div className="rounded-xl p-3 border border-[#758A7D] bg-white/10 group">
              ...
              <div className="my-3 relative overflow-hidden rounded-lg">
                <Image
                  ...
                  height={500}
                  width={300}
                  src={"https://eyolo-nextjs.vercel.app/images/splash/demos/maintenance.jpg"}
                  alt="Inner page image"
                />
                <span className="py-2 pl-4 pr-5 rounded-full bg-primary text-white uppercase flex gap-1 justify-center items-center w-fit absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 whitespace-nowrap text-xs">
                  <Image
            ...
            <div className="rounded-xl p-3 border border-[#758A7D] bg-white/10 group">
              ...
              <div className="my-3 relative overflow-hidden rounded-lg">
                <Image
                  ...
                  height={500}
                  width={300}
                  src={"https://eyolo-nextjs.vercel.app/images/splash/demos/category-single.jpg"}
                  alt="Inner page image"
                />
                <Link
                  href={"/category/web"}
            ...
            <div className="rounded-xl p-3 border border-[#758A7D] bg-white/10 group">
              ...
              <div className="my-3 relative overflow-hidden rounded-lg">
                <Image
                  ...
                  height={500}
                  width={300}
                  src={"https://eyolo-nextjs.vercel.app/images/splash/demos/author-single.jpg"}
                  alt="Inner page image"
                />
                <Link
            ...
            <div className="rounded-xl p-3 border border-[#758A7D] bg-white/10 group">
              ...
              <div className="my-3 relative overflow-hidden rounded-lg">
                <Image
                  ...
                  height={500}
                  width={300}
                  src={"https://eyolo-nextjs.vercel.app/images/splash/demos/video-single.jpg"}
                  alt="Inner page image"
                />
                <Link
                  href={"/videos"}
            ...
            <div className="rounded-xl p-3 border border-[#758A7D] bg-white/10 group">
              ...
              <div className="my-3 relative overflow-hidden rounded-lg">
                <Image
                  ...
                  height={500}
                  width={300}
                  src={"https://eyolo-nextjs.vercel.app/images/splash/demos/donation.jpg"}
                  alt="Inner page image"
                />
                <span className="py-2 pl-4 pr-5 rounded-full bg-primary text-white uppercase flex gap-1 justify-center items-center w-fit absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 whitespace-nowrap text-xs">
                  <Image
            ...
            <div className="rounded-xl p-3 border border-[#758A7D] bg-white/10 group">
              ...
              <div className="my-3 relative overflow-hidden rounded-lg">
                <Image
                  ...
                  height={500}
                  width={300}
                  src={"https://eyolo-nextjs.vercel.app/images/splash/demos/privacy.jpg"}
                  alt="Inner page image"
                />
                <Link
                  href={"/privacy"}
            ...
            <div className="rounded-xl p-3 border border-[#758A7D] bg-white/10 group">
              ...
              <div className="my-3 relative overflow-hidden rounded-lg">
                <Image
                  ...
                  height={500}
                  width={300}
                  src={"https://eyolo-nextjs.vercel.app/images/splash/demos/terms.jpg"}
                  alt="Inner page image"
                />
                <Link
                  href={"/terms"}
            ...
            <div className="rounded-xl p-3 border border-[#758A7D] bg-white/10 group">
              ...
              <div className="my-3 relative overflow-hidden rounded-lg">
                <Image
                  ...
                  height={500}
                  width={300}
                  src={"https://eyolo-nextjs.vercel.app/images/splash/demos/add-a-feature.jpg"}
                  alt="Inner page image"
                />
                <span className="py-2 pl-4 pr-5 rounded-full bg-primary text-white uppercase flex gap-1 justify-center items-center w-fit absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 whitespace-nowrap text-xs">
                  <Image
            ...
            <div className="rounded-xl p-3 border border-[#758A7D] bg-white/10 group">
              ...
              <div className="my-3 relative overflow-hidden rounded-lg">
                <Image
                  ...
                  height={500}
                  width={300}
                  src={"https://eyolo-nextjs.vercel.app/images/splash/demos/404.jpg"}
                  alt="Inner page image"
                />
                <Link
                  href={"/404"}
