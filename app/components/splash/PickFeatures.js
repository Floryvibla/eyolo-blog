      ...
      <div className="container">
        ...
        <div className="grid gap-4 sm:gap-6 grid-cols-1 md:grid-cols-2 xl:grid-cols-3">
          <div className="bg-[#0a0a0a] row-span-3 rounded-2xl border-2 border-[#2F2F2F] p-6 md:p-6 lg:p-8 flex flex-col justify-center">
            ...
            <div className="mx-auto relative h-fit w-full bg-[url('https://eyolo-nextjs.vercel.app/images/splash/features-icon/feature4.svg')] bg-[length:95%_100%] bg-no-repeat">
              <div className="w-fit relative shadow-[rgba(0,_0,_0,_0.2)_0px_60px_40px_-7px]">
                <Image
                  className="md:max-w-[200px] 2xl:max-w-fit"
                  src="https://eyolo-nextjs.vercel.app/images/splash/page-speed1.svg"
                  width="252"
                  height="252"
                  alt="Shape"
                />
              ...
              <div className="w-fit ml-auto relative xl:-mt-12">
                <Image
                  className="md:max-w-[200px] 2xl:max-w-fit"
                  src="https://eyolo-nextjs.vercel.app/images/splash/page-speed2.svg"
                  width="236"
                  height="239"
                  alt="Shape"
                />
          ...
          <div className="bg-white/50 row-span-2 rounded-2xl border-2 border-[#DCDBD0] p-6 md:p-6 lg:p-8 flex flex-col justify-center">
            ...
            <Image
              className="ml-auto"
              src="https://eyolo-nextjs.vercel.app/images/splash/features-icon/feature2.svg"
              width="412"
              height="265"
              alt="Icon"
            />
          ...
          <div className="bg-[#415649] row-span-2 rounded-2xl border-2 border-[#627669] p-6 md:p-6 lg:p-8 flex flex-col justify-center">
            ...
            <Image
              className="mx-auto"
              src="https://eyolo-nextjs.vercel.app/images/splash/features-icon/feature3.svg"
              width="320"
              height="233"
              alt="Icon"
            />
          ...
          <div className="bg-white/50 row-span-2 rounded-2xl border-2 border-[#DCDBD0] p-6 md:p-6 lg:p-8">
            ...
            <Image
              ...
              src="https://eyolo-nextjs.vercel.app/images/splash/features-icon/feature5.svg"
              width="466"
              height="285"
              alt="Icon"
            />
          ...
          <div className="bg-white/50 row-span-1 rounded-2xl border-2 border-[#DCDBD0] p-6 lg:p-6 xl:py-3 xl:px-6 2xl:p-8 flex justify-between items-center flex-row">
            ...
            <Image
              ...
              src="https://eyolo-nextjs.vercel.app/images/splash/features-icon/feature6.svg"
              width="125"
              height="125"
              alt="Icon"
            />
          ...
          <div className="bg-white/50 row-span-1 rounded-2xl border-2 border-[#DCDBD0] p-6 lg:p-6 xl:py-3 xl:px-6 2xl:p-8 flex justify-between items-center flex-row">
            ...
            <Image
              className="ml-auto"
              src="https://eyolo-nextjs.vercel.app/images/splash/features-icon/feature1.svg"
              height="120"
              width="120"
              alt="Icon"
            />
          ...
          <div className="bg-[#0a0a0a] row-span-1 rounded-2xl border-2 border-[#2F2F2F] p-6 lg:p-6 xl:py-3 xl:px-6 2xl:p-8 flex justify-between items-center flex-row">
            ...
            <Image
              className="ml-auto"
              src="https://eyolo-nextjs.vercel.app/images/splash/features-icon/feature7.svg"
              width="125"
              height="125"
              alt="Icon"
            />
